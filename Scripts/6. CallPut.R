  ...
  #Computing Prices of different Call options
    ...
    ggplot(data.frame(S = c(80, 120)), aes(x = S))+
      ...
      stat_function(fun = Vectorize(eu_option_price, c("S")),
                    args = list(t = 0, endT = 0.25, K = 100, sigma = 0.2, r = 0.05),
                    aes(color = "0.25"),
                    size = 0.75)+
      stat_function(fun = Vectorize(eu_option_price, c("S")),
                    args = list(t = 0, endT = 0.50, K = 100, sigma = 0.2, r = 0.05),
                    aes(color = "0.50"),
                    size = 0.75)+
      stat_function(fun = Vectorize(eu_option_price, c("S")),
                    args = list(t = 0, endT = 0.75, K = 100, sigma = 0.2, r = 0.05),
                    aes(color = "0.75"),
                    size = 0.75)+
      scale_colour_manual(name = "Tid til udløb (T-t):",
    ...
    ggplot(data.frame(S = c(80, 120)), aes(x = S))+
      ...
      stat_function(fun = Vectorize(eu_option_price, c("S")),
                    ...
                    size = 0.75)+
      stat_function(fun = Vectorize(eu_option_price, c("S")),
                    args = list(t = 0, endT = 0.25, K = 100, sigma = 0.2, r = 0.1),
                    aes(color = "0.05"),
                    size = 0.75)+
      stat_function(fun = Vectorize(eu_option_price, c("S")),
                    args = list(t = 0, endT = 0.25, K = 100, sigma = 0.2, r = 0.15),
                    aes(color = "0.10"),
                    size = 0.75)+
    ...
    ggplot(data.frame(S = c(80, 120)), aes(x = S))+
      ...
      stat_function(fun = Vectorize(eu_option_price, c("S", "r")),
                    ...
                    size = 0.75)+
      stat_function(fun = Vectorize(eu_option_price, c("S")),
                    args = list(t = 0, endT = 0.25, K = 100, sigma = 0.4, r = 0.05),
                    aes(color = "0.4"),
                    size = 0.75)+
      stat_function(fun = Vectorize(eu_option_price, c("S")),
                    args = list(t = 0, endT = 0.25, K = 100, sigma = 0.6, r = 0.05),
                    aes(color = "0.6"),
                    size = 0.75)+
...
melt(BS_MC_Price_estimator(mu = 0.05, sigma = 0.2, S = 100, endT = 0.25, K = 100),
  ...
  geom_line(aes(color = "0.50"),
      ...
      geom_hline(yintercept = c(eu_option_price(S = 100, K = 100, r = 0.05, sigma = 0.2, t = 0, endT = 0.25),
                                eu_option_price(S = 100, K = 100, r = 0.05, sigma = 0.2, t = 0, endT = 0.50),
                                eu_option_price(S = 100, K = 100, r = 0.05, sigma = 0.2, t = 0, endT = 0.75)),
                 color = "black")+
      scale_colour_manual(name = "Tid til udløb (T-t):",
                          values = c("0.25" = brewer.pal(3,"Dark2")[1],
                                     "0.50" = brewer.pal(3,"Dark2")[2],
  ...
  ggsave("./Output/Plots/MCCalltime.PNG",
    ...
    melt(BS_MC_Price_estimator(mu = 0.05, sigma = 0.2, S = 100, endT = 0.25, K = 100),
      ...
      geom_line(aes(color = "0.10"),
                melt(BS_MC_Price_estimator(mu = 0.10, sigma = 0.2, S = 100, endT = 0.25, K = 100),
                     id.vars = "n"))+
      geom_line(aes(color = "0.15"),
                melt(BS_MC_Price_estimator(mu = 0.15, sigma = 0.2, S = 100, endT = 0.25, K = 100),
                     id.vars = "n"))+
      scale_y_continuous(limits = c(4,14), expand = c(0,0))+
      scale_x_continuous(expand = c(0,0,0.01,0))+
      geom_hline(yintercept = c(eu_option_price(S = 100, K = 100, r = 0.05, sigma = 0.2, t = 0, endT = 0.25),
                                eu_option_price(S = 100, K = 100, r = 0.10, sigma = 0.2, t = 0, endT = 0.25),
                                eu_option_price(S = 100, K = 100, r = 0.15, sigma = 0.2, t = 0, endT = 0.25)),
                 color = "black")+
      scale_colour_manual(name = "Risiko fri rente (r):",
                          values = c("0.05" = brewer.pal(3,"Dark2")[1],
                                     "0.10" = brewer.pal(3,"Dark2")[2],
                                     "0.15" = brewer.pal(3,"Dark2")[3]),
    ...
    #Changing volatility
    BS_MC_Price_estimator(mu = 0.05, sigma = 0.2, S = 100, endT = 0.25, K = 100) %>% 
      melt(id.vars = "n") %>% 
      ggplot(aes(x = n, y = value, group = variable))+
      ylab("") + xlab("")+
      ...
      geom_line(aes(color = "0.4"),
                #alpha = 0.6,
                melt(BS_MC_Price_estimator(mu = 0.05, sigma = 0.4, S = 100, endT = 0.25, K = 100),
                     id.vars = "n"))+
      geom_line(aes(color = "0.6"),
                #alpha = 0.4,
                melt(BS_MC_Price_estimator(mu = 0.05, sigma = 0.6, S = 100, endT = 0.25, K = 100),
                     id.vars = "n"))+
      scale_y_continuous(limits = c(4,14), expand = c(0,0))+
      scale_x_continuous(expand = c(0,0,0.01,0))+
      geom_hline(yintercept = c(eu_option_price(S = 100, K = 100, r = 0.05, sigma = 0.2, t = 0, endT = 0.25),
                                eu_option_price(S = 100, K = 100, r = 0.05, sigma = 0.4, t = 0, endT = 0.25),
                                eu_option_price(S = 100, K = 100, r = 0.05, sigma = 0.6, t = 0, endT = 0.25)),
                 color = "black")+
